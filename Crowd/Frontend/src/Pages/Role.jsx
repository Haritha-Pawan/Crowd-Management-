...
const Role = () => {
  return (
    <div className="role-section relative lg:-top-2 2xl:-top-100 md:-top-6 max-sm:-mt-40">
      ...
      <div className="sub-titl flex justify-center text-xl font-light text-[var(--color-secondary)] mb-11 max-sm:text-x">
      ...
      <div className="role-based grid lg:grid-cols-4 md:grid-cols-2 gap-4 mx-10 ">
        ...
        <Link to="/Login">
          ...
          <div className="role1 bg-white/5 p-5 h-55 rounded-md border-2 border-white/10 cursor-pointer hover:scale-95">
            <div className="icon w-14 mx-auto mb-5 rounded-4xl">
              <img src={assets.card2} alt="System Admin" />
            </div>
            <div className="title text-white text-2xl text-center mb-4">
              System Admin
            </div>
        ...
        <Link to="/Login">
          ...
          <div className="role1 bg-white/5 p-5 h-55 rounded-md border-2 border-white/10 cursor-pointer hover:scale-95">
            <div className="icon w-14 mx-auto mb-5 rounded-4xl">
              <img src={assets.card3} alt="Event Organizer" />
            </div>
            <div className="title text-white text-2xl text-center mb-4">
              Event Organizer
            </div>
        ...
        <Link to="/Login">
          <div className="role1 bg-white/5 p-5 h-55 rounded-md border-2 border-white/10 cursor-pointer hover:scale-95">
            <div className="icon w-14 mx-auto mb-5 rounded-4xl">
              <img src={assets.card4} alt="Event Coordinator" />
            </div>
            <div className="title text-white text-2xl text-center mb-4">
              Event Coordinator
            </div>
...
<Link to="/Counterstaff">
        ...
        <div className="role1 bg-white/5 p-5 h-55 rounded-md border-2 border-white/10 cursor-pointer hover:scale-95">
          <div className="icon w-14 mx-auto mb-5 rounded-4xl">
            <img src={assets.card4} alt="Counter Staff" />
          </div>
          <div className="title text-white text-2xl text-center mb-4">
            Counter Staff
          </div>
