...
const UserManagement = () => {
  ...
  return (
    ...
    <div className="gap-5">
    {/* Add user button */}
     <button onClick={() => setIsPopupOpen(true)} className="absolute top-12 right-50 p-3 px-8 mx-4  rounded-md cursor-pointer bg-green-500 text-white font-medium shadow-lg hover:opacity-80 focus:outline-none transition-all">
        + view Attende
      </button>
     {/* view attende */}
       <button onClick={() => setIsPopupOpen(true)} className="absolute top-12 right-12 p-3 px-8 rounded-md cursor-pointer bg-gradient-to-r from-blue-500 to-purple-600 text-white font-medium shadow-lg hover:opacity-80 focus:outline-none transition-all">
        + Add User
      </button>
      ...
      <div className="search-section bg-white/5 border border-white/10 p-5 mt-5 rounded-md ">
        ...
        <div className="flex gap-10 mt-3">
          <div className="flex flex-col">
            ...
            />
            <Search className=" relative bottom-7 ml-2  color='#fffff " size={20} />
          </div>
