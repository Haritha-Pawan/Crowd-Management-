...
const SidebarDash = ({title,subtitle,links}) => {


  return (
    <div className="left 2xl:flex-1/12 flex-wrap inline p-4 bg-white/10 border border-white/10 text-white max-sm:hidden h-screen sticky top-0">
      <Link to="/">
