      ...
      <div className="Register-wrapper bg-white/10 border border-white/10 w-full sm:w-[90%] md:w-[500px] lg:w-[600px] xl:w-[650px] p-8 rounded-xl shadow-xl">
        ...
        <form className='space-y-5'>
          ...
          <div>
            ...
            <label className='text-slate-300 block mb-1 '>NIC Number *</label>
            <input type="text" placeholder='Enter your NIC' className='w-full bg-white/5 border border-white/10 p-[6px] rounded-md placeholder:text-slate-400 text-white'/>
          ...
          <div>
            ...
            <input type="text" placeholder='Enter your Full Name' className='w-full bg-white/5 border border-white/10 p-[6px] rounded-md placeholder:text-slate-400 text-white'/>
          ...
          <div>
            ...
            <input type="text" placeholder='Enter your Phone number' className='w-full bg-white/5 border border-white/10 p-[6px] rounded-md placeholder:text-slate-400 text-white'/>
